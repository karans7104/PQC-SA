...
REM ================================================================
REM  build_validation.bat — Build and run KEM correctness tests
REM  Tests: round-trip, tamper detection, key independence, wrong-SK
REM ================================================================
...
for %%K in (2 3 4) do (
    ...
    echo.
    echo ================================================================
    echo   Building Kyber-!LEVEL! ^(KYBER_K=%%K^)
    echo ================================================================

    %CC% %CFLAGS% -DKYBER_K=%%K %INCLUDES% %SRCS% -o validation_kyber%%K.exe -ladvapi32

    if !errorlevel! == 0 (
        echo   Running validation...
        validation_kyber%%K.exe
        del validation_kyber%%K.exe 2>nul
    ) else (
